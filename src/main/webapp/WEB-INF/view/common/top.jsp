...
<div class="container-fulid">
	<nav class="navbar navbar-light bg-light">
		...
		<img alt="CMS" src="/resource/images/qq.gif " style="width: 70px ; height: 70px">
		<img alt="CMS" src="/resource/images/qq.gif " style="width: 70px ; height: 70px">
		<img alt="CMS" src="/resource/images/qq.gif " style="width: 70px ; height: 70px">
		<img alt="CMS" src="/resource/images/qq.gif " style="width: 70px ; height: 70px">
		<img alt="CMS" src="/resource/images/qq.gif " style="width: 70px ; height: 70px">
		...
		<img alt="CMS" src="/resource/images/qq.gif " style="width: 70px ; height: 70px">
		<img alt="CMS" src="/resource/images/qq.gif " style="width: 70px ; height: 70px">
		<img alt="CMS" src="/resource/images/qq.gif " style="width: 70px ; height: 70px"></a>
			...
			<c:choose>
				...
				<c:when test="${sessionScope.user != null}">
					<li class="nav-item"><a class="nav-link" href="/my/home">
							<img alt="" src="/resource/images/tou.jpg"
